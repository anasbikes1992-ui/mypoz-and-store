...
Live host: `https://mypoz-and-store-ui.vercel.app`. **Do not** put `/welcome` in App domains or the webhook callback.

### Meta Developer app (GRABBER) field map

| Meta field | Value |
|---|---|
| App domains | `mypoz-and-store-ui.vercel.app` (host only, no `https://`, no path) |
| Site URL / Facebook Login | `https://mypoz-and-store-ui.vercel.app/welcome` |
| Privacy policy URL | `https://mypoz-and-store-ui.vercel.app/privacy-policy` |
| Terms of Service URL | `https://mypoz-and-store-ui.vercel.app/terms-of-service` |
| Data deletion instructions URL | `https://mypoz-and-store-ui.vercel.app/data-deletion` |
| WhatsApp → Configuration → Callback URL | `https://mypoz-and-store-ui.vercel.app/api/whatsapp/webhook` |
